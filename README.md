# Build a Rapid Response Virtual Agent with Genesys and Google Cloud
...
![Rapid Response Virtual Agent](blueprint/images/flowchart.png "Rapid Response Virtual Agent")